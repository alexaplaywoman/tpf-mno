...
INSERT INTO DEPARTAMENTOS (ID_DEPARTAMENTO, ID_EDIFICIO, NOMBRE) VALUES (5, 3, 'DIS - Diseño Gráfico e Industrial');
...
INSERT INTO CARRERAS (ID_CARRERA, ID_DEPARTAMENTO, NOMBRE) VALUES (5, 5, 'Diseño Gráfico');
...
/* Lab 6 en "Biblioteca Pablo VI" (edificio 1) y lab 7 en "Ciencias Contables"
   (edificio 2): antes no tenian ningun laboratorio cargado, por lo que esos
   edificios no ofrecian ninguna opcion en el paso "Elegir Laboratorio". */
INSERT INTO LABORATORIOS (NUMERO_LABORATORIO, ID_EDIFICIO, NRO_PISO, ESTADO, EDIFICIO, CAPACIDAD_ALUMNOS, CANTIDAD_COMPUTADORAS, VELOCIDAD_CONEXION_INTERNET)
VALUES (6, 1, 1, 1, 'Biblioteca Pablo VI', 20, 20, 100);
INSERT INTO LABORATORIOS (NUMERO_LABORATORIO, ID_EDIFICIO, NRO_PISO, ESTADO, EDIFICIO, CAPACIDAD_ALUMNOS, CANTIDAD_COMPUTADORAS, VELOCIDAD_CONEXION_INTERNET)
VALUES (7, 2, 1, 1, 'Ciencias Contables', 25, 25, 100);
